  ...
  "group/button relative isolate inline-flex shrink-0 items-center justify-center overflow-hidden rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-[color,border-color,box-shadow,transform,background-color] outline-none select-none before:pointer-events-none before:absolute before:inset-0 before:z-0 before:origin-left before:scale-x-0 before:bg-[var(--button-fill)] before:transition-transform before:duration-300 before:ease-out hover:before:scale-x-100 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&>*]:relative [&>*]:z-10 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-secondary-foreground [--button-fill:color-mix(in_oklch,var(--secondary),var(--foreground)_5%)] hover:text-secondary-foreground aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost:
          "bg-transparent [--button-fill:var(--muted)] hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:[--button-fill:color-mix(in_oklch,var(--muted),white_8%)]",
        destructive:
          "bg-destructive/10 text-destructive [--button-fill:color-mix(in_oklch,var(--destructive)_18%,white)] hover:text-destructive focus-visible:border-destructive/40 focus-visible:ring-destructive/20 dark:bg-destructive/20 dark:[--button-fill:color-mix(in_oklch,var(--destructive)_28%,black)] dark:focus-visible:ring-destructive/40",
